...
// When testing services keep two things in mind
// 1. is there actual business logic to be tested. A service method that just calls and returns a DAO method
// 2. if the test relies on a dependency (a DAO for example) the dependency should be mocked
// by mocking we can assume that the dependency works correctly and test only the service method logic
